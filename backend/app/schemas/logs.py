...
class BaseLog(BaseModel):
    log_type: Annotated[
        LogType | None, Field(alias="logType", description="日志类型")
    ] = None
    by_user: Annotated[str | None, Field(alias="logUser", description="操作人")] = None
    log_detail: Annotated[
        str | None, Field(alias="logDetail", description="日志详细")
    ] = None
    create_time: Annotated[
        datetime | None, Field(alias="creationTime", description="创建时间")
    ] = None
...
class BaseAPILog(BaseModel):
    ...
    user_agent: Annotated[
        str | None, Field(max_length=255, description="User-Agent")
    ] = None
    request_url: Annotated[str | None, Field(max_length=255, description="请求URL")] = (
        None
    )
...
class LogSearch(BaseModel):
    ...
    log_user: Annotated[
        str | None, Field(alias="logUser", description="操作人员, 用户名")
    ] = None
    log_detail: Annotated[
        str | None, Field(alias="logDetail", description="日志详细")
    ] = None
    request_url: Annotated[
        str | None, Field(alias="requestUrl", description="请求URL")
    ] = None
    ...
    time_range: Annotated[
        str | None, Field(alias="timeRange", description="时间范围, 逗号隔开")
    ] = None
    response_code: Annotated[
        str | None, Field(alias="responseCode", description="响应业务码")
    ] = None
