const local: App.I18n.Schema = {
  ...
  page: {
    ...
    metric: {
      ...
      metricPlaceholder: 'Metric Search',
      formTile: {
    ...
    dataAsset: {
      database: {
        ...
        createBy: 'Creator',
        status: 'Status',
        databaseDesc: 'Description',
        addDatabase: 'Add Database',
        editDatabase: 'Edit Database',
        form: {
          databaseName: 'Please enter name',
          databaseType: 'Please select type',
          databaseHost: 'Please enter host',
          databasePort: 'Please enter port',
          databaseDatabase: 'Please enter database',
          status: 'Please select status',
          databaseUser: 'Please enter username',
          password: 'Please enter password',
          databaseDesc: 'Please enter description',
      ...
      dataModel: {
        ...
        dataModelDesc: 'Model Description',
