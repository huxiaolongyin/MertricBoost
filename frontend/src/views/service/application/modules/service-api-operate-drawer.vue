    ...
    <NDrawerContent>
      ...
      <NForm ref="formRef" class="ml-2 mt-5" :rules="rules" :model="model">
        ...
        <div class="ml-10">
          ...
          >
            <NInput
              v-model:value="model.apiName"
              placeholder="1~64个字符，需以中文、字母开头，仅支持中文、字母、数字、“-”、“_”"
            />
          </NFormItem>
          <NFormItem
            label="API Path"
          ...
          >
            <NInput
              v-model:value="model.apiPath"
              placeholder="1~64个字符，支持小写字母、数字和下划线，只能以小写字母和数字开头，比如users"
            />
          </NFormItem>
          <NFormItem
            label="API 描述"
          ...
          <NFormItem
            ...
            path="appId"
          >
            <NSelect v-model:value="model.appId" :options="appOptions" />
          </NFormItem>
        </div>
      </NForm>
      <NFlex align="center" class="mb-5">
      ...
      <NModal v-model:show="showModal">
        <ApiAdd
          ...
          v-model:paramList="model.params"
...
} = useLoadOptions(() => fetchServiceAppList({ status: "1" }), "databaseName", "id");
