...
class DataDomain(BaseModel, TimestampMixin):
    ...
    data_domain_name = fields.CharField(max_length=50, description="数据域名称")
    data_domain_desc = fields.CharField(max_length=255, description="数据域描述")
...
class TopicDomain(BaseModel, TimestampMixin):
    ...
    id = fields.IntField(pk=True)
    topic_domain_name = fields.CharField(max_length=50, description="数据域名称")
    topic_domain_desc = fields.CharField(max_length=255, description="数据域描述")
    create_by = fields.ForeignKeyField(
