...
from metricboost.controllers.log import log_controller
from metricboost.controllers.user import user_controller
from metricboost.core.ctx import CTX_USER_ID
from metricboost.core.response import Error, Fail, Success, SuccessExtra
from metricboost.models.system import APILog, Log, LogType, Role, User
from metricboost.schemas.logs import LogSearch, LogUpdate
...
async def _(log_in: LogSearch = Depends()):
    ...
    return SuccessExtra(data=data, total=total, page=log_in.page, page_size=log_in.size)
