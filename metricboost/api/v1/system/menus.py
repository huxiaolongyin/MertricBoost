...
from metricboost.models.system import LogDetailType, LogType, Menu
from metricboost.schemas.menus import MenuCreate, MenuUpdate
...
async def _(
    ...
    page_size: int = Query(100, description="每页数量", alias="pageSize"),
):
