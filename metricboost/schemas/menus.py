...
from metricboost.models.system import IconType, MenuType
...
class MenuBase(BaseModel):
    ...
    path_param: Annotated[
        str | None, Field(max_length=200, alias="pathParam", description="路径参数")
    ] = None
    route_param: Annotated[
        list[dict[str, Any]] | None, Field(alias="query", description="路由参数列表")
    ] = []
    ...
    parent_id: Annotated[
        int | None, Field(alias="parentId", description="父菜单ID")
    ] = None
    i18n_key: Annotated[
        str | None,
        Field(alias="i18nKey", description="用于国际化的展示文本，优先级高于title"),
    ] = None

    icon: Annotated[str | None, Field(description="图标名称")] = None
    icon_type: Annotated[
        IconType | None, Field(alias="iconType", description="图标类型")
    ] = None

    href: Annotated[str | None, Field(description="外链")] = None
    multi_tab: Annotated[
        bool | None, Field(alias="multiTab", description="是否支持多页签")
    ] = None
    keep_alive: Annotated[
        bool | None, Field(alias="keepAlive", description="是否缓存")
    ] = None
    hide_in_menu: Annotated[
        bool | None, Field(alias="hideInMenu", description="是否在菜单隐藏")
    ] = None
    active_menu: Annotated[
        str | None, Field(alias="activeMenu", description="隐藏的路由需要激活的菜单")
    ] = None
    fixed_index_in_tab: Annotated[
        int | None, Field(alias="fixedIndexInTab", description="固定在页签的序号")
    ] = None
